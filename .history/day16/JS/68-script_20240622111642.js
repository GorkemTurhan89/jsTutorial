...
const fillTable = (country)=>{
    ...
    let mapLink = `<a href="https://maps.google.com/maps?q=${country.latlng.toString()}" target="_blank">`;
        ...
        document.querySelector("#countriesTable tr:nth-child(3) td").innerHTML = currency;
        document.querySelector("#countriesTable tr:nth-child(5) td").innerHTML = aream;
        document.querySelector("#countriesTable tr:nth-child(4) td").innerHTML = mapLink;
}
